...
// ColorGame, ma per il riconoscimento delle emozioni di base.
MiniGame {
    id: g
    title: qsTr("Le emozioni")
    age: qsTr("3-4 anni")
    levelCount: 12

    readonly property var emotions: ["😀", "😢", "😠", "😲", "😨", "😴"]
    ...
    function load(i) {
        ...
        mistakes = 0
        answered = false
        choices = shuffle([0, 1, 2, 3, 4, 5]).slice(0, 4)
        ...
        Grid {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    Text {
                        anchors.centerIn: parent
                        text: g.emotions[parent.modelData]
                        font.pixelSize: 80
                    }
                    MouseArea {
                        id: cma
